...
the slides generated by [Marp](https://github.com/yhatt/marp)
...
2. [前端开发者不得不知的 ES6 十大特性](http://www.alloyteam.com/2016/03/es6-front-end-developers-will-have-to-know-the-top-ten-properties/)
...
Because, in fact, it not only return a function, but also included a context that returned functinon refer to.
...
1. Change var to let/const. let/const works in block scope, they are not global variables any more, so they would not contaminate the global variables when defined outside method. IIFE is outdate!
